...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Poppy Playtime Chapter 6",
    description: "Read the Terms of Service for Poppy Playtime Chapter 6. Learn about user responsibilities, content usage guidelines, and legal terms for using our horror game resource platform.",
    keywords: [
      'terms of service',
      "Poppy Playtime Chapter 6 terms",
      'user agreement',
      'legal terms',
      'usage policy',
    ],
    ...
    openGraph: {
      ...
      title: "Terms of Service - Poppy Playtime Chapter 6",
      description: "Terms and conditions for using Poppy Playtime Chapter 6.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Poppy Playtime Chapter 6
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Poppy Playtime Chapter 6 ("the Website", "we", "our", or "us"), you agree to be bound
              by these Terms of Service ("Terms"). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you ("User", "you", or "your") and Poppy Playtime Chapter 6.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Poppy Playtime Chapter 6 is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Poppy Playtime game series. Our services include, but are not limited to:
            </p>
            <ul>
            ...
            <p>
              <strong>Important:</strong> Poppy Playtime Chapter 6 is NOT affiliated with, endorsed by, or associated with
              Mob Entertainment or the official developers of Poppy Playtime. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Poppy Playtime Chapter 6 and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Mob Entertainment and/or the developers of Poppy Playtime. We use such
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, POPPY PLAYTIME CHAPTER 6 SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Poppy Playtime Chapter 6 regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@poppyplaytimechapter6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@poppyplaytimechapter6.wiki</a>
            </p>
            <p>
