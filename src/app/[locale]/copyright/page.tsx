...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Poppy Playtime Chapter 6',
    description: 'Copyright and intellectual property information for Poppy Playtime Chapter 6. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    keywords: [
      'copyright notice',
      'Poppy Playtime Chapter 6 copyright',
      'DMCA policy',
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Poppy Playtime Chapter 6',
      description: 'Copyright and intellectual property information for Poppy Playtime Chapter 6.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2025-2026 Poppy Playtime Chapter 6. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Poppy Playtime Chapter 6 and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Poppy Playtime Chapter 6 is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Mob Entertainment</strong> - Developers of Poppy Playtime</li>
              <li><strong>Steam / Valve Corporation</strong> - Owner of the Steam platform</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Poppy Playtime</strong> - Trademark of Mob Entertainment</li>
              <li><strong>Poppy Playtime Chapter 6</strong> - Our own branding (not affiliated with Mob Entertainment)</li>
            </ul>
            <p>
              ...
              affiliation with Poppy Playtime Chapter 6.
            </p>
            ...
            <p>
              ...
              Poppy Playtime Chapter 6<br />
              Email: <a href="mailto:dmca@poppyplaytimechapter6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@poppyplaytimechapter6.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to "Poppy Playtime Chapter 6"</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>"Source: Poppy Playtime Chapter 6 (poppyplaytimechapter6.wiki)"</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@poppyplaytimechapter6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@poppyplaytimechapter6.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@poppyplaytimechapter6.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@poppyplaytimechapter6.wiki</a>
            </p>
            <p>
